...
class CycleGANStructModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            # shuxian: additional args for structural loss
    ...
    def __init__(self, opt):
        ...
        # Only save fake_B (Arthur Levisalles)
        visual_names_A = ['fake_B']  # consider to add 'rec_A' for evaluation
        visual_names_B = [] 
    ...
    def backward_G(self):
        ...
        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.loss_struct
        if self.opt.amp:
